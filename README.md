...
A pre-propsed [Hackclub](https://hackclub.com/) YSWS (You ship we ship) program.

The idea is create the best/coolest program you can while keeping it as small as possible. You get prizes.
